                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="fa-solid fa-cart-shopping"></i> Servicios y Ventas
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px">
                            {{-- @if (auth()->user()->hasPermission('add_people')) --}}
                            <a href="{{ route('services-sales.create') }}" class="btn btn-success">
                                <i class="voyager-plus"></i> <span>Registrar Ventas</span>
                            </a>
                            {{-- @endif --}}
                        </div>
                    </div>
